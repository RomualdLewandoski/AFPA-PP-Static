...
class render3DPlayer {
    private $fallback_img = 'skin/char.png';
    ...
    private function getSkinURL() {
        ...
        return 'skin/' . $this->playerName . '.png';
    }
        ...
        switch($this->format) {
            case 'svg':
                ...
                echo '<?xml version="1.0" standalone="no"?>
						...
						"https://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">' . $result . "\n";
    ...
    private function displayImage($output) {
        ...
        $imgOutput = '';
        if($this->format == 'svg') {
            $imgOutput .= '<svg width="100%" height="100%" version="1.1" xmlns="https://www.w3.org/2000/svg" viewBox="' . $minX . ' ' . $minY . ' ' . $width . ' ' . $height . '">';
        }
